//
//  NightscoutServiceSettingsViewController.swift
...
final class NighscoutServiceSettingsViewController: UITableViewController, CompletionDelegate {
    ...
    init(service: NightscoutService, chartColors: ChartColorPalette, carbTintColor: Color, glucoseTintColor: Color, guidanceColors: GuidanceColors, insulinTintColor: Color) {
    ...
    @objc private func startFlow() {
        let setupViewController = SettingsReviewUICoordinator(chartColors: chartColors, carbTintColor: carbTintColor, glucoseTintColor: glucoseTintColor, guidanceColors: guidanceColors, insulinTintColor: insulinTintColor)
